...
def draw(canvas):
    if face1:
        ...
        canvas.draw_circle((width/3,height/3),5, 10,'Black','Black')
        canvas.draw_circle((width/5,height/3),5, 10,'Black','Black')
        canvas.draw_circle((width/4,height/2),5, 10,'Black','Black')
    if face2:
        canvas.draw_circle((width/2, height/2), width/2 - 50, 10, "Yellow", "Yellow")
        canvas.draw_circle((width/3,height/3),5, 10,'Black','Black')
        canvas.draw_circle((width/5,height/3),5, 10,'Black','Black')
...
frame.add_button("Boot Button", toggle_face5, 100)
